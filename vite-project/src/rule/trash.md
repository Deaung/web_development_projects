...
```html    
    ...
    <div className="wrapper">
      <div className="title">
        <img src="img/clock.png" alt="background_logo" className="clock_img"/>
        <div className="title_img">
          <img src="img/title.png" alt="1만시간 법칙"/>
        </div>
      </div>
      <div className="intro">
        <div className="intro_saying">&quot;연습은 어제 당신보다 당신을 더 낫게 만든다.&quot;</div>
          <div className="explain">
            ...
            <p>
              <span>1만 시간의 법칙</span>은<br/>어떤 분야의 전문가가 되기 위해서는<br/>
      ...
      <div className="inputs">
        <div className="field">
          <p>나는</p>
          <input type="text" id="field_velue" placeholder="예) 프로그래밍"/>
          <p>전문가가 될 것이다</p>
        </div>
        <div className="time">
          <p>그래서 앞으로 매일</p>
